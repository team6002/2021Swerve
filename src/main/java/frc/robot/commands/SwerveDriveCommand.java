...
public class SwerveDriveCommand extends CommandBase {
  ...
  public void execute() {
    ...
    final var xSpeed =
      -xspeedLimiter.calculate(jStickBand(controller.getY(GenericHID.Hand.kLeft)))
    ...
    final var ySpeed =
      -yspeedLimiter.calculate(jStickBand(controller.getX(GenericHID.Hand.kLeft)))
        * SwerveDrivetrain.kMaxSpeed;
    ...
    final var rot =
      -rotLimiter.calculate(jStickBand(controller.getX(GenericHID.Hand.kRight)))
